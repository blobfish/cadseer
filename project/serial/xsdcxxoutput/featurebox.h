...
/**
 * @file
 * @brief Generated from featurebox.xsd.
 */

#ifndef PRJ_SRL_FEATUREBOX_H
#define PRJ_SRL_FEATUREBOX_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureBox schema type.
     *
     * @nosubgrouping
     */
    class FeatureBox: public ::xml_schema::Type
    {
      public:
      /**
       ...
       */
      FeatureBox (const FeatureCSysBaseType&,
                  const LengthType&,
                  const WidthType&,
                  const HeightType&);
       ...
       */
      FeatureBox (::std::unique_ptr< FeatureCSysBaseType >,
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %box document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureBox&);

    /**
     * @name Serialization functions for the %box document root.
     */
    //@{
    ...
    box (const ::prj::srl::FeatureBox& x, 
         const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
         ::xml_schema::Flags f = 0);

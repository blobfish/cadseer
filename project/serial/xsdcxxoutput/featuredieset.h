...
/**
 * @file
 * @brief Generated from featuredieset.xsd.
 */

#ifndef PRJ_SRL_FEATUREDIESET_H
#define PRJ_SRL_FEATUREDIESET_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureDieSet schema type.
     *
     * @nosubgrouping
     */
    class FeatureDieSet: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::Parameter LengthPaddingType;
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::Parameter WidthPaddingType;
       ...
       */
      FeatureDieSet (const FeatureBaseType&,
                     const LengthType&,
                     const LengthPaddingType&,
                     const WidthType&,
                     const WidthPaddingType&,
       ...
       */
      FeatureDieSet (::std::unique_ptr< FeatureBaseType >,
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %dieset document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureDieSet&);

    /**
     * @name Serialization functions for the %dieset document root.
     */
    //@{
    ...
    dieset (const ::prj::srl::FeatureDieSet& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            ::xml_schema::Flags f = 0);

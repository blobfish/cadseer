...
/**
 * @file
 * @brief Generated from featurehollow.xsd.
 */

#ifndef PRJ_SRL_FEATUREHOLLOW_H
#define PRJ_SRL_FEATUREHOLLOW_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %HollowPick schema type.
     *
     * @nosubgrouping
     */
    class HollowPick: public ::xml_schema::Type
    {
      public:
      /**
       * @name faceId
    ...
    /**
     * @brief Class corresponding to the %HollowPicks schema type.
     *
     * @nosubgrouping
     */
    class HollowPicks: public ::xml_schema::Type
    {
      public:
      /**
       * @name array
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::HollowPick ArrayType;
    ...
    /**
     * @brief Class corresponding to the %FeatureHollow schema type.
     *
     * @nosubgrouping
     */
    class FeatureHollow: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
       ...
       * @name hollowPicks
       *
       * @brief Accessor and modifier functions for the %hollowPicks
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::HollowPicks HollowPicksType;
       ...
       */
      void
      hollowPicks (::std::unique_ptr< HollowPicksType > p);
       ...
       * initializers for required elements and attributes.
       */
      FeatureHollow (const FeatureBaseType&,
                     const HollowPicksType&,
                     const OffsetType&);
       ...
       */
      FeatureHollow (::std::unique_ptr< FeatureBaseType >,
                     ::std::unique_ptr< HollowPicksType >,
      ...
      ::xsd::cxx::tree::one< HollowPicksType > hollowPicks_;
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %hollow document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const HollowPick&);

    void
    operator<< (::xercesc::DOMElement&, const HollowPicks&);

    void
    operator<< (::xercesc::DOMElement&, const FeatureHollow&);

    /**
     * @name Serialization functions for the %hollow document root.
     */
    //@{
    ...
    hollow (const ::prj::srl::FeatureHollow& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            ::xml_schema::Flags f = 0);

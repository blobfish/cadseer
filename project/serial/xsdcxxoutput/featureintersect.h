...
/**
 * @file
 * @brief Generated from featureintersect.xsd.
 */

#ifndef PRJ_SRL_FEATUREINTERSECT_H
#define PRJ_SRL_FEATUREINTERSECT_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureIntersect schema type.
     *
     * @nosubgrouping
     */
    class FeatureIntersect: public ::xml_schema::Type
    {
      public:
      /**
       ...
       */
      FeatureIntersect (const FeatureBooleanBaseType&);
       ...
       */
      FeatureIntersect (::std::unique_ptr< FeatureBooleanBaseType >);
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %intersect document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureIntersect&);

    /**
     * @name Serialization functions for the %intersect document root.
     */
    //@{
    ...
    intersect (::std::ostream& os,
               const ::prj::srl::FeatureIntersect& x, 
    ...
    intersect (const ::prj::srl::FeatureIntersect& x, 
               const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
               ::xml_schema::Flags f = 0);
...
#endif // PRJ_SRL_FEATUREINTERSECT_H

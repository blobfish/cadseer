...
/**
 * @file
 * @brief Generated from featurenest.xsd.
 */

#ifndef PRJ_SRL_FEATURENEST_H
#define PRJ_SRL_FEATURENEST_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureNest schema type.
     *
     * @nosubgrouping
     */
    class FeatureNest: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %nest document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureNest&);

    /**
     * @name Serialization functions for the %nest document root.
     */
    //@{
    ...
    nest (const ::prj::srl::FeatureNest& x, 
          const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
          ::xml_schema::Flags f = 0);

...
/**
 * @file
 * @brief Generated from featureoffset.xsd.
 */

#ifndef PRJ_SRL_FEATUREOFFSET_H
#define PRJ_SRL_FEATUREOFFSET_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureOffset schema type.
     *
     * @nosubgrouping
     */
    class FeatureOffset: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
       ...
       */
      FeatureOffset (const FeatureBaseType&,
                     const PicksType&,
                     const DistanceType&,
                     const DistanceLabelType&);
       ...
       */
      FeatureOffset (::std::unique_ptr< FeatureBaseType >,
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %offset document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureOffset&);

    /**
     * @name Serialization functions for the %offset document root.
     */
    //@{
    ...
    offset (const ::prj::srl::FeatureOffset& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            ::xml_schema::Flags f = 0);

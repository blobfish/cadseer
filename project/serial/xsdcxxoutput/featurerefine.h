...
/**
 * @file
 * @brief Generated from featurerefine.xsd.
 */

#ifndef PRJ_SRL_FEATUREREFINE_H
#define PRJ_SRL_FEATUREREFINE_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureRefine schema type.
     *
     * @nosubgrouping
     */
    class FeatureRefine: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
       ...
       */
      FeatureRefine (const FeatureBaseType&,
                     const ShapeMapType&);
       ...
       */
      FeatureRefine (::std::unique_ptr< FeatureBaseType >,
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %refine document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureRefine&);

    /**
     * @name Serialization functions for the %refine document root.
     */
    //@{
    ...
    refine (const ::prj::srl::FeatureRefine& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            ::xml_schema::Flags f = 0);

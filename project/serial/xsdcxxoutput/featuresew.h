...
/**
 * @file
 * @brief Generated from featuresew.xsd.
 */

#ifndef PRJ_SRL_FEATURESEW_H
#define PRJ_SRL_FEATURESEW_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureSew schema type.
     *
     * @nosubgrouping
     */
    class FeatureSew: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
       ...
       */
      FeatureSew (const FeatureBaseType&,
                  const SolidIdType&,
                  const ShellIdType&);
       ...
       */
      FeatureSew (::std::unique_ptr< FeatureBaseType >,
                  const SolidIdType&,
                  const ShellIdType&);
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %sew document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureSew&);

    /**
     * @name Serialization functions for the %sew document root.
     */
    //@{
    ...
    sew (const ::prj::srl::FeatureSew& x, 
         const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
         ::xml_schema::Flags f = 0);

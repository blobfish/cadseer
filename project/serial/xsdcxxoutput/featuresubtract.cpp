...
namespace prj
{
  namespace srl
  {
    ...
    const FeatureSubtract::TargetPicksType& FeatureSubtract::
    targetPicks () const
    {
      return this->targetPicks_.get ();
    }

    FeatureSubtract::TargetPicksType& FeatureSubtract::
    targetPicks ()
    {
      return this->targetPicks_.get ();
    }
    ...
    const FeatureSubtract::ToolPicksType& FeatureSubtract::
    toolPicks () const
    {
      return this->toolPicks_.get ();
    }

    FeatureSubtract::ToolPicksType& FeatureSubtract::
    toolPicks ()
    {
      return this->toolPicks_.get ();
    }

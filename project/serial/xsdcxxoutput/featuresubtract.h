...
/**
 * @file
 * @brief Generated from featuresubtract.xsd.
 */

#ifndef PRJ_SRL_FEATURESUBTRACT_H
#define PRJ_SRL_FEATURESUBTRACT_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureSubtract schema type.
     *
     * @nosubgrouping
     */
    class FeatureSubtract: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %subtract document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureSubtract&);

    /**
     * @name Serialization functions for the %subtract document root.
     */
    //@{
    ...
    subtract (::std::ostream& os,
              const ::prj::srl::FeatureSubtract& x, 
    ...
    subtract (const ::prj::srl::FeatureSubtract& x, 
              const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
              ::xml_schema::Flags f = 0);
...
#endif // PRJ_SRL_FEATURESUBTRACT_H

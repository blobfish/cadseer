...
/**
 * @file
 * @brief Generated from featureunion.xsd.
 */

#ifndef PRJ_SRL_FEATUREUNION_H
#define PRJ_SRL_FEATUREUNION_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureUnion schema type.
     *
     * @nosubgrouping
     */
    class FeatureUnion: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %fUnion document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureUnion&);

    /**
     * @name Serialization functions for the %fUnion document root.
     */
    //@{
    ...
    fUnion (const ::prj::srl::FeatureUnion& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            ::xml_schema::Flags f = 0);
